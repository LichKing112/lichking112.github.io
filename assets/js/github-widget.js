(function() {
    let allPayloadData, cls, get, getNext, init, jsonp, make, makeWidget, text,
    ...
    makeWidget = function(payloadData, div) {
      let j, len, limit, made, opts, ref, ref1, repo, results, siteRepoNames, sortBy, user;
      make({
        cls: 'gw-clearer',
        prevSib: div
      });
                ...
                make({
                  ...
                  kids: [
                    make({  
                      tag: 'a',
                      href: repo.html_url,
                      text: repo.archived ? `${repo.name} [Archived]` : `${repo.name}`,
                      cls: 'gw-name'
                    })
                  ]
    ...
    cls = function(el, opts) {
      let c, classHash, classes, hasClasses, j, l, len, len1, ref;
      if (opts == null) {
        opts = {};
      }
      classHash = {};
    ...
    get = function(opts) {
      let el, els, hasCls, inside, ref, ref1, ref2, ref3, tag;
      if (opts == null) {
        opts = {};
      }
